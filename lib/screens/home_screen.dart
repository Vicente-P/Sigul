...
import 'package:sigul/screens/map_screen.dart' hide Building;
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void _navegarASala(String seleccion) {
    ...
    if (edificioEncontrado.name.isNotEmpty) {
      ...
      // Cambiar a la pantalla de Edificios y luego navegar al panorama
      _pageController.jumpToPage(4);
      setState(() {
        _selectedIndex = 4;
      });

      // Usar un Future.delayed para asegurar que la página cambie primero
                      ...
                      Container(
                        ...
                        child: TextField(
                          ...
                          decoration: InputDecoration(
                            ...
                            hintText:
                                'Buscar edificio o sala (ej: Edificio P, P201)...',
                        ...
                        Container(
                          ...
                          child: ListView.separated(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              final edificio =
                                  BuildingData.buscarEdificioPorSala(
                                    sala,
                                  );
    ...
    return Card(
      ...
      child: InkWell(
        ...
        onTap: () {
          ...
          // Navegar al panorama después de cambiar la página
          Future.delayed(Duration(milliseconds: 100), () {
            if (mounted) {
              Navigator.push(
                context,
