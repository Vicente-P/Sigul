...
class _NotasScreenState extends State<NotasScreen> {
  ...
  void _agregarNota(
    ...
    List<Evaluacion> evaluacionesActualizadas = List.from(_currentAsignatura.evaluaciones)
      ..add(nuevaEvaluacion);
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          actions: [
            ...
            ElevatedButton(
              onPressed: () async {
                List<Evaluacion> evaluacionesActualizadas = _currentAsignatura.evaluaciones
                    ...
                    child: Row(
                      ...
                      children: [
                        Tooltip(
                          ...
                          child: Icon(Icons.trending_up, color: _getColorCalificacion(promedio)),
                        ),
                        SizedBox(width: 8),
                        Text(
                          'Promedio: ',
                      ...
                      return Card(
                        ...
                        child: ListTile(
                          ...
                          leading: CircleAvatar(
                            backgroundColor: _getColorCalificacion(evaluacion.calificacion),
                            child: Text(
                          ...
                          subtitle: Column(
                            ...
                            children: [
                              ...
                              if (evaluacion.fecha != null)
                                Text(
                                  DateFormat('dd/MM/yyyy').format(evaluacion.fecha!),
                                  style: TextStyle(
                                    fontSize: 12,
                                    color: AppColors.textSecondary,
                                  ),
